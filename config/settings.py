...
STATIC_URL = 'static/'
STATIC_ROOT = os.path.join(BASE_DIR, 'staticfiles') # Onde o Django vai reunir o CSS
...
# Permite que o formulário funcione no domínio do Railway
CSRF_TRUSTED_ORIGINS = [
    'https://casamentocarlajefferson.up.railway.app',
    'https://*.127.0.0.1'
]
